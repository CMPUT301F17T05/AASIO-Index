...
public class InitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user.Exists) {
            ...
            //user.addFollowee(UUID.fromString("a47f3482-c537-4cdd-a6cd-1244a2424151"));
            //remote.removeFollower(UUID.fromString("e06459d4-27f1-49de-b8e8-85ab5b3469ef"));
            //UserAccount remote = UserAccount.fromId(UUID.fromString("a47f3482-c537-4cdd-a6cd-1244a2424151"));
